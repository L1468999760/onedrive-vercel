...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'yinxingshuxiadeshaonian@outlook.com',
  ...
  protectedRoutes: ['/加密文件'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:1468999760@qq.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/L1468999760/onedrive-vercel',
    },
  ],
